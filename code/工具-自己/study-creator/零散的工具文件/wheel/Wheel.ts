...
export class Wheel extends Component {
    ...
    private addEvent() {
        EventManager.getInstance().addEventListener(BaseEventName.mess_common_app_hide_show, this.onPageShowHide, this);
    }

    private removeEvent() {
        EventManager.getInstance().removeEventListener(BaseEventName.mess_common_app_hide_show, this.onPageShowHide, this);
    }
